...
Notes: 
        1.R11 value on schematic to be updated to 10 kΩ.
        2.The OPA333 and IRLR7843 combination itself works very slowly and is only suitable for linear modes, which is exactly what we are talking about.
